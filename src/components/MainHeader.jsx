...
import resume from "../assets/RESUME-PriyanshuVerma.pdf";
...
const MainHeader = () => {
  return (
    <div className="w-11/12 max-w-3xl  mx-auto h-screen text-center flex flex-col items-center gap-4 justify-center  ">
      ...
      <h3 className="flex items-center gap-2 text-xl md:text-2xl mb-3 font-Ovo dark:text-white">
      <TextType 
  text={[` Hi! I'm Priyanshu Vema `, "for your help!", "Feel free to reach out!"]}
  typingSpeed={75}
  pauseDuration={1500}
  showCursor={true}
  cursorCharacter="|"
...
<img src={handIcon} alt="" />
      ...
      Full-Stack Developer from Greater Noida, open to Internships and Freelance opportunities to build scalable, user-focused applications.
      </p>
